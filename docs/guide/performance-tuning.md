...
- [`BENCHMARKS.md`](https://github.com/timescale/rsigma/blob/main/BENCHMARKS.md) for the full Criterion results across parser, evaluator, correlation engine, runtime, and dynamic pipelines.
